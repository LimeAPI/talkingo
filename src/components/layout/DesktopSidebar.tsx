...
const tabs: { id: HomeTab; label: string; icon: typeof MessageCircle; color: string }[] = [
  ...
  { id: 'learn', label: 'Learn', icon: GraduationCap, color: 'text-primary' },
  { id: 'history', label: 'History', icon: Clock, color: 'text-primary' },
  ...
  return (
    <nav
      className={cn(
        ...
        'shadow-[0_12px_40px_-12px_rgba(0,0,0,0.40),0_0_0_1px_oklch(var(--primary)/0.05)_inset]'
      )}
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-2xl border-2 border-current/30 bg-primary/10"
