 ...
 *
 * Note: scenario completion is intentionally NOT decided here. The conversation
 * layer owns that call (see recordLessonAttempt in ConversationPage) because it
 * holds the AI mastery signal and the live turn count needed for the smart
 * 3-state gate. Marking here would force-complete a scenario regardless of how
 * the learner actually spoke.
 */
