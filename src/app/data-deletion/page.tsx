  ...
  return (
    ...
    >
      ...
      <Section title="7. CCPA-Specific Rights (California Users)">
        ...
        <p className="mt-2">To exercise CCPA rights, email <strong>privacy@talkingo.ai</strong>.</p>
      </Section>

      <Section title="8. Contact">
        <p>For any questions about data deletion or your privacy rights, contact our Data Protection team:</p>
