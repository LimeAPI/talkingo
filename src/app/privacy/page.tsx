    ...
    >
      ...
      <Section title="1. Information We Collect">
        <SubSection title="1.1 Account Information">
          ...
          authentication method (Google or Facebook). Talkingo uses social sign-in only and never creates or
          stores a password for you. We also store your language preferences and learning progress.
        </SubSection>
      ...
      <Section title="7. Your Rights">
        ...
        <p className="mt-2">
          ...
          <Link href="/data-deletion" className="text-[oklch(var(--color-accent-dim))] underline underline-offset-2 hover:text-[oklch(var(--color-accent))]">
            Data Deletion page
          </Link>{' '}
