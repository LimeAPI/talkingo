        ...
        <div className="rounded-xl border border-border/40 p-3 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 px-3 py-2 rounded-lg bg-primary text-white text-xs font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-1.5 disabled:opacity-60"
            >
